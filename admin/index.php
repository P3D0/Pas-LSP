      ...
      <div class="row">
        <div class="col-sm">
          ...
          <table class="table table-bordered border-primary">
            ...
            <td><?= $mhs["matkul"]; ?></td>
            <td>
            <button type="button" class="btn btn-danger"><a href="ubah.php?id=<?= $mhs["id"]; ?>" class="text-white">ubah</a></button>
            <button type="button" class="btn btn-warning"><a href="hapus.php?id=<?= $mhs["id"]; ?>" class="text-white">hapus</a></button>
            </td>
            </tr>
            <?php $no++; ?>
            <?php endforeach; ?>
